...
app.listen(port, () => {
  ...
  console.log('- http://localhost:5002/api/test');
  console.log('- http://localhost:5002/api/rooms');
  console.log('- http://localhost:5002/api/students');
  console.log('- http://localhost:5002/api/payments');
  console.log('- http://localhost:5002/api/payments/pending');
  console.log('- http://localhost:5002/api/payments/overdue');
  console.log('- http://localhost:5002/api/payments/due-in-week');
});
