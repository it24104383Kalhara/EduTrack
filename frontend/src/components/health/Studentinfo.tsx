...
import "../../css/health/Studentinfo.css";
  ...
  return (
    <div className="student-page">
      ...
      <div className="student-page-header">
        ...
        <h1>
          Add <span>Student Details</span>
        </h1>
        <p className="student-subtitle">
          Register new student health information into the system.
        </p>
      </div>
      ...
      <form className="student-form-card" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={(e) =>
              setStudent({ ...student, symptoms: e.target.value })
            }
            required
          />
        </div>
