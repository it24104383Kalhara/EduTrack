import "../../css/health/Dashboard.css";
...
const HospitalIcon = () => (
  <svg viewBox="0 0 24 24">
    <path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0H5m14 0H5m0 0H3" />
    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-header">
        <div className="dashboard-badge">
          <SparkleIcon /> Health Management
        </div>
        <h1>
          Welcome to <span>EduTrack</span>
        </h1>
        <p className="dashboard-subtitle">
          Manage student health records, monitoring &amp; more — all in one
          place.
        </p>
      </div>
