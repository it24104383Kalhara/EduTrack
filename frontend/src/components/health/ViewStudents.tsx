...
import "../../css/health/ViewStudents.css";
  ...
  return (
    <div className="view-students-page">
      ...
      <div className="view-students-header">
        ...
        <p className="view-students-subtitle">
          Browse and manage all registered student health records.
        </p>
      </div>
        ...
        <div className="date-blocks-wrapper">
          {Object.entries(groupedStudents).map(([date, dateStudents]) => (
            <div key={date} className="date-block">
              ...
              >
                ...
                <div className="date-block-controls">
                  <span className="student-count badge">
                    {dateStudents.length}{" "}
                    {dateStudents.length === 1 ? "Student" : "Students"}
                  </span>
                  <svg
                    className={`chevron ${expandedDate === date ? "open" : ""}`}
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div
                className={`date-block-content ${expandedDate === date ? "open" : ""}`}
              >
