    ...
    <div className="hrm-root">
      ...
      <main className="hrm-main">
        ...
        <div className="hrm-top-row">
          ...
          <div className="hrm-card">
            <div className="hrm-conn-header">
              <span className={`hrm-conn-dot${isConnected ? " connected" : ""}`} />
              <span className="hrm-conn-label">
                {isConnected ? "Connected to ESP32" : "Connecting…"}
              </span>
              <span className={`hrm-conn-badge${isConnected ? " connected" : " disconnected"}`}>
        ...
        <div className="hrm-hero-card">
          <div className={`hrm-heart-icon${fingerDetected ? " beating" : ""}`}>❤️</div>

          <div className="hrm-bpm-row">
            <span className={`hrm-bpm-value ${status === "waiting" ? "" : status}`}>
              {heartRate}
            </span>
            <span className="hrm-bpm-unit">BPM</span>
          </div>

          <div className={`hrm-status-badge ${status === "waiting" ? "" : status}`}>
            {statusLabels[status]}
          </div>
